          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="post" action="">
                <div class="mb-3">
                  <label for="editbasketball<?=$row["city_ID"]?>Name" class="form-label">City Abbreviation</label>
                          <input type="text" class="form-control" id="editbasketball<?=$row["city_ID"]?>Name" aria-describedby="editbasketball<?=$row["city_ID"]?>Help" name="icityabrv">
                          <label for="editbasketball<?=$row["city_ID"]?>Name" class="form-label">City Full Name</label>
                          <input type="text" class="form-control" id="editbasketball<?=$row["city_ID"]?>Name" aria-describedby="editbasketball<?=$row["city_ID"]?>Help" name="icityname">
                          <div id="editbasketball<?=$row["city_ID"]?>Help" class="form-text">Enter the cities info.</div>
                        </div>
